...
src/api.js reads VITE_API_BASE env var (set during Netlify build)
          ↓
= https://car-rental-plantform.vercel.app/api/cars/top-browse
          ↓
...
| ---------------------- | ---------------------------------------------------- | --------------------------------------------------------------------- |
| **Frontend API URL**   | Hardcoded: `https://car-rental-plantform.vercel.app` | Dynamic: reads `VITE_API_BASE` env var                                |
...
```
OLD SETUP:
Frontend URL hardcoded to: https://car-rental-plantform.vercel.app
