...
6. **Note your backend URL** (e.g., `https://car-rental-plantform.vercel.app`)
...
3. **Set Environment Variables on Netlify**
   ...
   - Add:
     - **Key:** `VITE_API_BASE`
     - **Value:** `https://car-rental-plantform.vercel.app` (replace with your actual Vercel backend URL)
...
1. Test backend directly in browser:
   ```
   https://car-rental-plantform.vercel.app/api/cars/top-rated
   ```
