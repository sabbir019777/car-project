          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            <div className="border-b border-white/10 pb-10 space-y-5">
              <h2 className="text-xl font-bold text-white flex items-center">
                <i className="fas fa-shield-alt mr-3 text-yellow-400"></i>{" "}
                Provider Information
              </h2>
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  <label className="block text-gray-300 font-semibold mb-1">
                    <i className="fas fa-user mr-1"></i> Provider Account ID{" "}
                ...
                <div>
                  <label className="block text-gray-300 font-semibold mb-1">
                    <i className="fas fa-envelope mr-1"></i> Account Email
            ...
            <div className="border-b border-white/10 pb-10 space-y-5">
              <h2 className="text-xl font-bold text-white flex items-center">
                <i className="fas fa-car mr-3 text-yellow-400"></i> Vehicle
                Specifications
              </h2>
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  <label className="block text-gray-300 font-semibold mb-1">
                    <i className="fas fa-car mr-1"></i> Car Name/Model{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-gray-300 font-semibold mb-1">
                    <i className="fas fa-dollar-sign mr-1"></i> Daily Rental
                    Prices (USD) <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="number"
                    id="rentPrice"
                ...
                <div>
                  <label className="block text-gray-300 font-semibold mb-1">
                    <i className="fas fa-tag mr-1"></i> Vehicles Category{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <select
                    id="category"
            ...
            <div className="border-b border-white/10 pb-10 space-y-5">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  <label className="block text-gray-300 font-semibold mb-1">
                    <i className="fas fa-map-marker-alt mr-1"></i> Primary
                ...
                <div>
                  <label className="block text-gray-300 font-semibold mb-1">
                    <i className="fas fa-image mr-1"></i> High-Quality Image URL{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="url"
