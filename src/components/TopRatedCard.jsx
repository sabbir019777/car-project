  ...
  useEffect(() => {
    const fetchCars = async () => {
      try {
        ...
        setError(
          "Failed to load cars. Please ensure backend server is running on port 3000."
        );
        setLoading(false);
      }
    };
    ...
    return (
      <div className="relative bg-gray-900 min-h-screen text-white flex flex-col justify-center items-center p-5">
        ...
        <p className="text-gray-400 text-center">
          {" "}
          Please make sure the backend is running and the port is 3000.
        </p>
      </div>
    );
  }
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-5 py-20">
        ...
        <div className="text-center mb-20 animate-fadeInUp">
          ...
          <p className="text-gray-300 max-w-xl mx-auto">
            {" "}
            Browse our top-rated luxury and performance vehicles loved by our
            customers.{" "}
          </p>
        </div>
            ...
            <AnimatePresence>
              {filteredCars.length === 0 && (
                <p className="col-span-full text-center text-gray-400 text-lg">
                  {" "}
                  No car found matching your criteria.
                </p>
              )}
