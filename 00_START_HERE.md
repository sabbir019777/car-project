...
8. **Save the Vercel URL** shown in the deployment (e.g., `https://car-rental-plantform.vercel.app`)
...
```
Frontend code: fetch("https://car-rental-plantform.vercel.app/api/cars")
              ↓ (hardcoded URL)
...
```
Netlify env var: VITE_API_BASE = https://car-rental-plantform.vercel.app
              ↓ (set before build)
...
1. Test backend directly: Open your Vercel URL in browser
   - Example: `https://car-rental-plantform.vercel.app`
